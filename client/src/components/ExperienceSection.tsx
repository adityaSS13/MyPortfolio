            ...
            return (
              ...
              >
                ...
                <div className="hidden md:flex flex-col items-center justify-center w-48 shrink-0">
                  <div className={`font-mono text-sm ${bracketColor[experience.color as keyof typeof bracketColor]}`}>
                ...
                <div className="flex-1">
                  <Card className={`bg-background p-6 border border-border ${colorClasses[experience.color as keyof typeof colorClasses]} transition-all duration-300 shadow-lg`}>
                    <CardContent className="p-0">
                      <div className="md:hidden text-sm text-muted-foreground mb-2">{experience.period}</div>
